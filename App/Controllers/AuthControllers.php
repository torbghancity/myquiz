...
class AuthControllers 
{
    ...
    public function HomeLogin()
    {
        ...
        Layout::render('Auth.login',['error'=>""]);
    ...
    public function DoLogin()
    {
        ...
        if ($result)
        {
            ...
            Layout::render('Auth.login',['error' => 'کاربری با این مشخصات موجود نمی باشد']);
        }
    }

    public function HomeRegister()
    {
        Layout::render('Auth.register',['error'=>""]);
    }
    ...
    public function DoRegister()
    {
        ...
        if ($result == "done"){
            ...
            Layout::render('Auth.register',['error'=>"$result"]);
        }
    }
