                ...
                <form action="" method="post">
                    <div class="border">
                        ...
                        <div class="question bg-white p-3 border-bottom">
                            <div class="d-flex flex-row align-items-center question-title">
                                ...
                                @if(strpos($opt2,"opt_images/")!==false)
                                    ...
                                    <div class="ans ml-2">
                                        <label class="radio"> 
                                            <input type="radio" name="opt" value="opt4"> 
                                    ...
                                    <div class="ans ml-2">
                                        <label class="radio"> <input type="radio" name="opt" value="opt2">
                                            <span>{{$opt2}}</span>
                                        </label>    
                                    </div>
                                    <div class="ans ml-2">
                        ...
                        <div class="d-flex flex-row justify-content-between align-items-center p-3 bg-white">
                            <button class="btn btn-primary d-flex align-items-center btn-danger" type="submit" name="previous">
                                <i class="fa fa-angle-left mt-1 mr-1"></i>&nbsp;
                                قبلی
                            </button>
                            <button class="btn btn-primary border-success align-items-center btn-success" type="submit" name="next">
                                بعدی
